...
const initialEdges = [
    { id: 'e1-2', source: 'n2', target: 'n1', type: 'default', animated: true, style: { stroke: '#e5e7eb', strokeWidth: 2 } },
    { id: 'e3-2', source: 'n2', target: 'n3', type: 'default', animated: true, style: { stroke: '#e5e7eb', strokeWidth: 2 } },
    { id: 'e2-4', source: 'n2', target: 'n4', type: 'default', animated: true, style: { stroke: '#e5e7eb', strokeWidth: 2 } }
];
